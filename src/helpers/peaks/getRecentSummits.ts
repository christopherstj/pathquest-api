...
const getRecentSummits = async (
    ...
    const rows = (
        ...
        FROM (
            SELECT a1.user_id, ap1.id, ap1.timestamp, ap1.activity_id, ap1.peak_id, ap1.notes, ap1.is_public, ap1.difficulty, ap1.experience_rating, a1.timezone 
            FROM activities_peaks ap1
            LEFT JOIN activities a1 ON ap1.activity_id = a1.id
            UNION
            SELECT user_id, id, timestamp, activity_id, peak_id, notes, is_public, difficulty, experience_rating, timezone 
